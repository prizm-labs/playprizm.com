...
},{"object-assign":8,"strict-uri-encode":9}],8:[function(require,module,exports){
'use strict';
...
var trackingExpirationDate = new Date( trackingPeriod + new Date().getTime() );
...
// get referrer from document
  ...
  } else if (document.referrer.indexOf("boardgame.geek.com")!=-1) {
    channel = "bgg"
...
},{"browser-cookies":5,"js-base64":6,"query-string":7}]},{},[10]);
